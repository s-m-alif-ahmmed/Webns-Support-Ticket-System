    ...
    <div id="companyUsers_user" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="company_users_all_user">Company Users All</label>
            </div>
            ...
            <ul class="row d-flex col-12">
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_manage_user"> User List</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_detail_user"> Detail</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_create_user"> Create</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_edit_user"> edit</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_create_info_user"> Create Info</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="company_user_update_info_user"> Update Info</label>
                    </div>
                </li>
                <li class="col-4">
                    <div class="form-check form-check-inline">
