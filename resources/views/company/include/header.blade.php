<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <!-- sidebar-toggle-->
            <a class="logo-horizontal" href="{{ route('company.dashboard') }}">
                <img src="{{asset('/')}}admin/images/brand/webns_logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{asset('/')}}admin/images/brand/webns_logo.png" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
...
{{--                                <a href="{{ route('home') }}" target="_blank" class="nav-link icon">--}}
...
{{--                                        </a>--}}
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        @if($company_admin->photo)
                                            <img src="{{asset( $company_admin->photo )}}" alt="Profile_Photo" class="avatar profile-user brround cover-image"/>
                                        @else
                                            @if($company_admin->gender == 'Male')
                                                <img src="{{ asset('/') }}admin/images/users/blank_image.jpg" alt="Profile_Photo" class="avatar profile-user brround cover-image"/>
                                            @elseif($company_admin->gender == 'Female')
                                                <img src="{{ asset('/') }}admin/images/users/default-avatar-photo-female-vector.jpg" alt="Profile_Photo" class="avatar profile-user brround cover-image"/>
                                            @elseif($company_admin->gender == 'Others')
                                                <img src="{{ asset('/') }}admin/images/users/default-avatar-photo-female-vector.jpg" alt="Profile_Photo" class="avatar profile-user brround cover-image"/>
                                            @endif
                                        @endif
                                    </span>
                                    <div class="text-center p-1 d-flex d-lg-none-max">
                                        @if($company_admin->name)
                                            <h6 class="mb-0" id="profile-heading">{{ $company_admin->name}}<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                        @else
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{ route('company.user.profile', Crypt::encryptString($company_admin->id)) }}">
                                    ...
                                    <form action="{{ route('company.logout') }}" method="POST" id="logoutForm">
                                        @csrf
                                    </form>
                                </div>
                            </div>
