...
{{--        Page header--}}
        ...
        <div class="row pt-5 pb-0 px-5">
            <div class="py-2 px-5 card card-body border-0 rounded-1 bg-white-4 justify-content-center">
                ...
                <h2>Welcome, {{ Session::get('company_user_name')}}</h2>
                @else
                    <h2>Welcome, </h2>
                @endif
                <h5>Dashboard</h5>
        ...
        @php
        $company_all_tickets = \App\Models\Admin\Ticket\Ticket::where('sub_company_id', $company_admin->sub_company_id)->latest()->get();
        $company_open_all_tickets = \App\Models\Admin\Ticket\Ticket::where('sub_company_id', $company_admin->sub_company_id)->where('status', 'Open')->latest()->get();
        $company_closed_all_tickets = \App\Models\Admin\Ticket\Ticket::where('sub_company_id', $company_admin->sub_company_id)->where('status', 'Closed')->latest()->get();
        $company_total_tickets = $company_all_tickets->count();
        $company_open_total_tickets = $company_open_all_tickets->count();
        $company_closed_total_tickets = $company_closed_all_tickets->count();


        $company_assign_users = \App\Models\Admin\Ticket\CompanyTicketAssign::whereHas('assignCompanyUser', function($query) use ($company_admin) {
        $query->where('sub_company_id', $company_admin->sub_company_id);
            })
            ->where('status', 'On')
            ->latest()
            ->get();
        $company_total_assign_users = $company_assign_users->count();
        @endphp
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-bold">{{ $company_total_tickets }}</h3>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-bold">{{ $company_open_total_tickets }}</h3>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-bold">{{ $company_closed_total_tickets }}</h3>
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-2 fw-bold">{{ $company_total_assign_users }}</h3>
                        ...
                        <div class="modal-body">
                            <div class=" p-3 ">
                                <form class="row g-3" action="{{ route('user.store.ticket') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="create_user_id" value="{{ old('create_user_id') }}" />
                                    ...
                                    <input type="hidden" name="update_company_user_id" value="{{ old('update_company_user_id') }}" />
                                    <input type="hidden" name="operation_end_time" value="{{ old('operation_end_time') }}" />
