                                        ...
                                        @foreach (auth()->user()->notifications as $notification)
                                            <a class="dropdown-item border-bottom" href="">
                                                <div class="notification-each d-flex">
                                                    <div class="me-3 notifyimg brround border">
                                                        <img src="{{ asset( $ticket->subCompany->image) }}" alt="" style="height: 20px; width: 20px;">
                                                    </div>
                                                    <div>
                                                        <span class="notification-label mb-1">{{ $notification->data['message'] }}</span>
                                                        <span class="notification-subtext text-muted">{{ $notification->created_at->diffForHumans() }}</span>
                                                    </div>
                                                    <div class="me-3">
                                                        <form action="{{ route('notifications.read', $notification->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            <button type="submit" class="btn btn-sm btn-primary">Read</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </a>
...
{{--                                    <div class="dropdown-divider m-0"></div>--}}
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
                                                    @if(Auth::user()->photo)
                                                        <img src="{{asset( Auth::user()->photo )}}" alt="Profile_Photo" class="avatar profile-user brround cover-image"/>
                                                    @else
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{ route('user.profile', Crypt::encryptString(Auth::user()->id)) }}">
