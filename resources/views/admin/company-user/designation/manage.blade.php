                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered text-nowrap border-bottom w-100" id="file-datatable" style="width:100%">
                        ...
                        <tr style="background-color: #FBA000FF;">
                            ...
                            <th class="fw-bold" style="color: white;"> Department Name </th>
                            <th class="fw-bold" style="color: white;"> Designation Name </th>
                            <th class="fw-bold" style="color: white;"> Designation Status </th>
                        ...
                        @foreach($designations as $designation)
                            <tr>
                                ...
                                <td>
                                    {{$designation->subCompany->name}} ({{ $designation->location->branch_code }})
                                </td>
                                    ...
                                    <div class="d-flex mt-3 mb-0">
                                        @if($permissionData && isset($permissionData['company_users_all']['designation_all']['designation_status']) && $permissionData['company_users_all']['designation_all']['designation_status'] == 'designation_status')
                                            @if($designation->status == 'Published')
                                                <a href="{{ route('change.designation.status', $designation->id) }}">
                                ...
                                <td class="text-center">
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6 justify-content-center">
                                        @if($permissionData && isset($permissionData['company_users_all']['designation_all']['designation_detail']) && $permissionData['company_users_all']['designation_all']['designation_detail'] == 'designation_detail')
                                            <a href="{{route('designation.show', Crypt::encryptString($designation->id))}}" class="btn all-btn-same">
                                                View
                                            </a>
                                        @endif
                                    </div>
