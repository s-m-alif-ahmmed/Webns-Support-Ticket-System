                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered text-nowrap border-bottom w-100" id="file-datatable" style="width:100%">
                        ...
                        <tr style="background-color: #FBA000FF;">
                            ...
                            <th class="fw-bold" style="color: white;"> Department Status </th>
                            <th class="fw-bold" style="color: white;"> Actions </th>
                        </tr>
                        </thead>
                        ...
                        @foreach($departments as $department)
                            <tr>
                                ...
                                <td>
                                    {{$department->subCompany->name}} ({{ $department->location->branch_code }})
                                </td>
                                    ...
                                    <div class="d-flex mt-3 mb-0">
                                        @if($permissionData && isset($permissionData['company_users_all']['department_all']['department_status']) && $permissionData['company_users_all']['department_all']['department_status'] == 'department_status')
                                            @if($department->status == 'Published')
                                                <a href="{{ route('change.department.status', $department->id) }}">
                                ...
                                <td class="text-center">
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6 justify-content-center">
                                        @if($permissionData && isset($permissionData['company_users_all']['department_all']['department_detail']) && $permissionData['company_users_all']['department_all']['department_detail'] == 'department_detail')
                                            <a href="{{route('department.show', Crypt::encryptString($department->id))}}" class="btn all-btn-same">
                                                View
                                            </a>
                                        @endif
                                    </div>
