<div class="container-fluid" id="assign-create">
    <!--ROW OPENED-->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header justify-content-between border-bottom">
                    ...
                    <button class="btn all-btn-same" id="assign-view-btn">Back</button>
                </div>
                <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="shipping-address" class="form-label text-muted mb-2">Shipping Address:</label>
                                        <textarea name="shipping-address" class="form-control w-60 d-none mb-2 text-dark" placeholder="Enter Address" id="shipping-address" cols="30" rows="5"></textarea>
                                        <a href="javascript:void(0)" role="button" class="text-primary text-center" id="addShippingAddress">
                    ...
                    <div class="row p-5">
                        ...
                        <form id="createForm" action="{{ route('ticket-assigns.store') }}" method="POST">
                            @csrf
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group px-1 py-1">
                                                        <div class="input-group-text bg-primary-transparent text-primary">
                                                            <i class="fe fe-calendar text-20 text-white"></i>
                                                        </div>
                                                        <input class="form-control" name="approx_end_time[]" type="datetime-local" />
                                                    </div>
                                                    <x-input-error :messages="$errors->get('approx_end_time')" class="mt-2" />
                                                </div>
                                            </div>

                                        </div>

                                        <i class="fa fa-times fs-20 text-muted text-center delete-row-btn ms-2"></i>

                                    </div>
                                </div>

                                <a href="javascript:void(0)" role="button" class="text-primary text-center add-invoice-item-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn text-primary" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                        <path d="M16,11.5h-3.5V8c0-0.276123-0.223877-0.5-0.5-0.5S11.5,7.723877,11.5,8v3.5H8c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h3.5v3.5005493C11.5001831,16.2765503,11.723999,16.5001831,12,16.5h0.0006104C12.2765503,16.4998169,12.5001831,16.276001,12.5,16v-3.5H16c0.276123,0,0.5-0.223877,0.5-0.5S16.276123,11.5,16,11.5z M12,2C6.4771729,2,2,6.4771729,2,12s4.4771729,10,10,10c5.5202026-0.0062866,9.9937134-4.4797974,10-10C22,6.4771729,17.5228271,2,12,2z M12,21c-4.9705811,0-9-4.0294189-9-9s4.0294189-9,9-9c4.9682617,0.0056152,8.9943848,4.0317383,9,9C21,16.9705811,16.9705811,21,12,21z"/>
                                    </svg>
                                    Add Member
