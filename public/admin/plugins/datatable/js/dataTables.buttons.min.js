...
*/
(function(e) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(y) {
    ...
    var q = e.fn.dataTable,
        ...
        x = q.ext.buttons,
        t = function(a, b) {
            if (!(this instanceof t)) return function(c) {
    ...
    t.instanceSelector = function(a, b) {
        if (a === r || null === a) return e.map(b, function(h) {
            return h.inst
        });
        var c = [],
    ...
    t.buttonSelector = function(a, b) {
        for (var c = [], d = function(g, n, k) {
                ...
                if (Array.isArray(g) || g instanceof e)
                    ...
                    for (l = 0, k = p.length; l < k; l++) c.push({
                        inst: n,
                        node: p[l].node
                    });
                else if ("number" === typeof g) c.push({
                    inst: n,
                    node: n.s.buttons[g].node
                });
                else if ("string" === typeof g)
                    if (-1 !== g.indexOf(","))
                        for (p = g.split(","), l = 0, k = p.length; l < k; l++) f(p[l].trim(),
                            n);
                    else if (g.match(/^\d+(\-\d+)*$/)) l = e.map(p, function(v) {
                    return v.idx
                }), c.push({
                    inst: n,
                    ...
                    for (g = g.replace(":name", ""), l = 0, k = p.length; l < k; l++) p[l].name === g && c.push({
                        inst: n,
                        node: p[l].node
                    });
                else e(l).filter(g).each(function() {
                    c.push({
                        inst: n,
                        node: this
                    })
                });
                else "object" === typeof g && g.nodeName && (p = e.inArray(g, l), -1 !== p && c.push({
                    inst: n,
                    node: l[p]
                }))
    ...
    q.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(!0, "table", function(d) {
            if (d._buttons) return t.buttonSelector(t.instanceSelector(a, d._buttons), b)
        }, !0);
        c._groupSelector = a;
        return c
    });
    ...
    q.Api.register("buttons.info()", function(a, b, c) {
        var d = this;
        if (!1 === a) return this.off("destroy.btn-info"), C(e("#datatables_buttons_info"), 400, function() {
            e(this).remove()
