...
(function(k) {
    ...
    function Ma(a, b, c) {
        ...
        n = {
            ...
            error: function(m, p, t) {
                t = H(a, null, "xhr", [a, null, a.jqXHR]); - 1 === k.inArray(!0, t) && ("parsererror" == p ? ca(a, 0, "Invalid JSON response", 1) : 4 === m.readyState && ca(a, 0, "Ajax error", 7));
                U(a, !1)
            }
        };
        a.oAjaxData = b;
    ...
    function Mb(a) {
        ...
        l = k("<div/>", {
            ...
            g : null).append(b.children("thead"))))).append(k("<div/>", {
            "class": f.sScrollBody
        }).css({
            position: "relative",
            overflow: "auto",
    ...
    var u = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) ca(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    f = r.asStripeClasses;
                    var I = p.children("tbody").find("tr").eq(0); - 1 !== k.inArray(!0, k.map(f, function(B, E) {
                        return I.hasClass(B)
        ...
        iterator: function(a, b, c, d) {
            ...
            for (f = h.length; m < f; m++) {
                ...
                if ("table" === b) {
                    ...
                    t !== q && e.push(t)
                } else if ("columns" === b || "rows" === b) t = c.call(p, h[m], this[m], m), t !== q && e.push(t);
    ...
    k.extend(u.ext.classes, {
        ...
        sLength: "dataTables_length me-2 form-group",
