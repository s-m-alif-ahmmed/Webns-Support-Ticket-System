...
(function(a) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-responsive"], function(b) {
    ...
    var d = c.modal,
        f = a('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div><div class="modal-body"/></div></div></div>'),
        g;
    a(function() {
        ...
        return function(l, h, m) {
            if (!a.fn.modal) d(l, h, m);
                ...
                if (k && k.header) {
                    ...
                    h.empty().append('<h4 class="modal-title">' + k.header(l) + "</h4>").append(n)
                }
