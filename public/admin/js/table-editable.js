(() => {
    ...
    $((function(e) {
        ...
        $(".table-edit tr").editable({
            ...
            save: function(e) {
                $(".edit-icn i", this).removeClass("fe-save").addClass("fe-pen").attr("title", "Edit"), this in t && (t[this].destroy(), delete t[this])
            },
            cancel: function(e) {
                $(".edit-icn i", this).removeClass("fe-save").addClass("fe-pen").attr("title", "Edit"), this in t && (t[this].destroy(), delete t[this])
            }
        ...
        }), (a = $("#editable-file-datatable").DataTable({
        ...
        })).buttons().container().appendTo("#editable-file-datatable_wrapper .col-md-6:eq(0)");
